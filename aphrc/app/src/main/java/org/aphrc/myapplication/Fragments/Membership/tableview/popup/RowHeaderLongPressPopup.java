...
public class RowHeaderLongPressPopup extends PopupMenu implements PopupMenu
    ...
    private void createMenuItem() {
        ...
        this.getMenu().add(Menu.NONE, UPD_COLUMN, 0, mContext.getString(R.string.newrec));
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case UPD_COLUMN:
                //Intent omg  = new Intent(mContext, OutmigrationActivity.class);
               // mContext.startActivity(omg);
                //omg.getExtras();
                break;
            ...
            case DEL_COLUMN:
                ...
                builder.setMessage("Are you sure want to delete " + GlobalClass.IndividualName+"?");
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dataBaseHelper.deleterecord("Membership",GlobalClass.memID);
                    }
                });
