...
package org.aphrc.myapplication.Fragments.Room.tableview;
...
import org.aphrc.myapplication.Fragments.Room.tableview.popup.ColumnHeaderLongPressPopup;
import org.aphrc.myapplication.Fragments.Room.tableview.popup.RowHeaderLongPressPopup;
...
public class TableViewListener implements ITableViewListener {
    ...
    public void onCellLongPressed(@NonNull RecyclerView.ViewHolder cellView, final int column,
        ...
        Cell id= (Cell)mTableView.getAdapter().getCellItem(3,row);
        Cell name= (Cell)mTableView.getAdapter().getCellItem(0,row);
        GlobalClass.rooID= id.getData().toString();
        GlobalClass.roomID= name.getData().toString();
