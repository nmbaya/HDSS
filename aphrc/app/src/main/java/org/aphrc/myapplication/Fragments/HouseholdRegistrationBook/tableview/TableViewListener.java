...
import org.aphrc.myapplication.Fragments.HouseholdRegistrationBook.tableview.popup.ColumnHeaderLongPressPopup;
import org.aphrc.myapplication.Fragments.HouseholdRegistrationBook.tableview.popup.RowHeaderLongPressPopup;
...
public class TableViewListener implements ITableViewListener {
    ...
    public void onCellLongPressed(@NonNull RecyclerView.ViewHolder cellView, final int column,
        ...
        Cell id= (Cell)mTableView.getAdapter().getCellItem(4,row);
        Cell name= (Cell)mTableView.getAdapter().getCellItem(0,row);
        GlobalClass.hrbID= id.getData().toString();
        GlobalClass.hrbNAME= name.getData().toString();

        if (cellView != null) {

            org.aphrc.myapplication.Fragments.HouseholdRegistrationBook.tableview.popup.RowHeaderLongPressPopup popup = new org.aphrc.myapplication.Fragments.HouseholdRegistrationBook.tableview.popup.RowHeaderLongPressPopup(cellView, mTableView);
            // Show
            popup.show();
        }
        // Do What you want
