...
public class RowHeaderLongPressPopup extends PopupMenu implements PopupMenu
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case SGP_COLUMN:
              Intent str  = new Intent(mContext, SocialgroupActivity.class);
                str.putExtra("Mode","N");
            ...
            case DEL_COLUMN:
                ...
                builder.setMessage("Are you sure want to delete " + GlobalClass.socialgroupID + "Socialgroup ?");
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dataBaseHelper.deleterecord("Socialgroup",GlobalClass.sgpID);
                    }
                });
            ...
            case UPDATE_COLUMN:
                Intent upd  = new Intent(mContext, SocialgroupActivity.class);
                mContext.startActivity(upd);
                break;

            case MEM_COLUMN:
                Intent mem  = new Intent(mContext, SocialgroupActivity.class);
                mContext.startActivity(mem);
                break;

            case HHH_COLUMN:
                Intent hhh  = new Intent(mContext, SocialgroupActivity.class);
