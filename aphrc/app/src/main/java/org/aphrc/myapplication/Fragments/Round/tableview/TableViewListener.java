...
import org.aphrc.myapplication.Fragments.Round.tableview.popup.ColumnHeaderLongPressPopup;
import org.aphrc.myapplication.Fragments.Round.tableview.popup.RowHeaderLongPressPopup;
...
public class TableViewListener implements ITableViewListener {
    ...
    public void onCellLongPressed(@NonNull RecyclerView.ViewHolder cellView, final int column,
        ...
        GlobalClass.roundID = id.getData().toString();
        GlobalClass.roundNumber = Integer.parseInt(name.getData().toString());

        if (cellView != null) {

            org.aphrc.myapplication.Fragments.Round.tableview.popup.RowHeaderLongPressPopup popup = new org.aphrc.myapplication.Fragments.Round.tableview.popup.RowHeaderLongPressPopup(cellView, mTableView);
            // Show
            popup.show();
        }
    }
