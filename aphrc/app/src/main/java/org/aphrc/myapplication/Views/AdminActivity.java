...
import org.aphrc.myapplication.Fragments.HouseholdRegistrationBook.HouseholdRegistrationBookFragment;
...
public class AdminActivity extends AppCompatActivity {
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        //replace the current fragment with the new fragment.
                         selectedFragment = selectDrawerItem(menuItem);
    ...
    public Fragment selectDrawerItem(MenuItem menuItem){
        ...
        switch(menuItem.getItemId()) {
            ...
            case R.id.nav_item_rnd:
                fragment = new RoundFragment();
                break;

            case R.id.nav_item_hrb:
                fragment = new HouseholdRegistrationBookFragment();
                break;
    ...
    {
        //selectedFragment.searchtest();
        //((selectedFragment.) fragment).searchtest();
    }
