...
import org.aphrc.myapplication.Fragments.Residency.tableview.popup.ColumnHeaderLongPressPopup;
import org.aphrc.myapplication.Fragments.Residency.tableview.popup.RowHeaderLongPressPopup;
...
public class TableViewListener implements ITableViewListener {
    ...
    public void onCellLongPressed(@NonNull RecyclerView.ViewHolder cellView, final int column,
        ...
        Cell name= (Cell)mTableView.getAdapter().getCellItem(2,row);
        GlobalClass.resID= id.getData().toString();
        GlobalClass.strNum= name.getData().toString();

        if (cellView != null) {

            org.aphrc.myapplication.Fragments.Residency.tableview.popup.RowHeaderLongPressPopup popup = new org.aphrc.myapplication.Fragments.Residency.tableview.popup.RowHeaderLongPressPopup(cellView, mTableView);
            // Show
            popup.show();
        }
