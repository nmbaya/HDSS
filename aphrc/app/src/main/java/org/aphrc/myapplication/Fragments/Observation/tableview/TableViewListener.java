...
package org.aphrc.myapplication.Fragments.Observation.tableview;
...
import org.aphrc.myapplication.Fragments.Observation.tableview.popup.ColumnHeaderLongPressPopup;
import org.aphrc.myapplication.Fragments.Observation.tableview.popup.RowHeaderLongPressPopup;
...
public class TableViewListener implements ITableViewListener {
    ...
    public void onCellLongPressed(@NonNull RecyclerView.ViewHolder cellView, final int column,
       ...
       // showToast("Cell " + column + " " + row + " has been long pressed.");
        ...
        Cell id= (Cell)mTableView.getAdapter().getCellItem(5,row);
        Cell name= (Cell)mTableView.getAdapter().getCellItem(0,row);
        GlobalClass.obsID= id.getData().toString();
        GlobalClass.observationID= name.getData().toString();
