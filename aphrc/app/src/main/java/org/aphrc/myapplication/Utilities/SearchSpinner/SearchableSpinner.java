package org.aphrc.myapplication.Utilities.SearchSpinner;
...
import org.aphrc.myapplication.Utilities.SearchSpinner.iconify.Iconify;
import org.aphrc.myapplication.Utilities.SearchSpinner.iconify.fonts.MaterialModule;
import org.aphrc.myapplication.Utilities.SearchSpinner.iconify.widget.IconTextView;

import org.aphrc.myapplication.Utilities.SearchSpinner.interfaces.ISpinnerSelectedView;
...
import org.aphrc.myapplication.Utilities.SearchSpinner.tools.EditCursorColor;
import org.aphrc.myapplication.Utilities.SearchSpinner.tools.UITools;
...
public class SearchableSpinner extends RelativeLayout implements View.OnClickListener {
    ...
    static {
        Iconify.with((IconFontDescriptor) new MaterialModule());
    }
