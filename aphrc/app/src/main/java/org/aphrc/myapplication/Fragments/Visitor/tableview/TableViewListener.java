package org.aphrc.myapplication.Fragments.Visitor.tableview;
...
import org.aphrc.myapplication.Fragments.Visitor.tableview.popup.ColumnHeaderLongPressPopup;
import org.aphrc.myapplication.Fragments.Visitor.tableview.popup.RowHeaderLongPressPopup;
...
public class TableViewListener implements ITableViewListener {
    ...
    public void onCellLongPressed(@NonNull RecyclerView.ViewHolder cellView, final int column,
        ...
        Cell id= (Cell)mTableView.getAdapter().getCellItem(2,row);
        Cell name= (Cell)mTableView.getAdapter().getCellItem(0,row);
        GlobalClass.sgpID= id.getData().toString();
        GlobalClass.socialgroupID= name.getData().toString();
