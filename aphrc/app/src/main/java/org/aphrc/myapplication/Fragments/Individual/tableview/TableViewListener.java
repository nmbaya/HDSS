...
import org.aphrc.myapplication.Fragments.Individual.tableview.popup.ColumnHeaderLongPressPopup;
import org.aphrc.myapplication.Fragments.Individual.tableview.popup.RowHeaderLongPressPopup;
...
public class TableViewListener implements ITableViewListener {
    ...
    public void onCellLongPressed(@NonNull RecyclerView.ViewHolder cellView, final int column,
        ...
        Cell id= (Cell)mTableView.getAdapter().getCellItem(14,row);
        Cell name= (Cell)mTableView.getAdapter().getCellItem(5,row);
        GlobalClass.indID= id.getData().toString();
        GlobalClass.IndividualName= name.getData().toString();
        // Do What you want
        if (cellView != null) {
            // Create Long Press Popup

            org.aphrc.myapplication.Fragments.Individual.tableview.popup.RowHeaderLongPressPopup popup = new org.aphrc.myapplication.Fragments.Individual.tableview.popup.RowHeaderLongPressPopup(cellView, mTableView);
            // Show
            popup.show();
        }
    }
