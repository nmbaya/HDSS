...
import org.aphrc.myapplication.Utilities.SearchSpinner.tools.textdrawable.util.ColorGenerator;
import org.aphrc.myapplication.Utilities.SearchSpinner.tools.textdrawable.TextDrawable;
...
public class SimpleArrayListAdapter extends ArrayAdapter<String> implements Filterable, ISpinnerSelectedView {
    ...
    private Drawable getTextDrawable(String displayName) {
